...
import { TextGenerateEffect } from './ui/text-genrate-effect'
    ...
    <div className='flex justify-center relative my-20 z-10'>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <p className='text-center md:tracking-wider mb-4 text-xs md:text-lg lg:text-2xl'>
                Hi, I&apos;m Shivansh, a dedicated Software Developer with a passion for building dynamic and intuitive software solutions. 
            </p>
            <a href='#about'>
                <MagicButton 
                title='Show my work'
